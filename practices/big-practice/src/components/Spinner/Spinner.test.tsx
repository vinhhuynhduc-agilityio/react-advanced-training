...
describe("Spinner Component", () => {
  ...
  it("should render the spinner correctly", () => {
    ...
    expect(spinnerDiv).toHaveClass("flex items-center justify-center w-full h-full");

    // Check for the inner spinning element
    const spinnerInner = container.querySelector(".w-12.h-12.border-4.border-gray-300.border-t-blue-500.rounded-full.animate-spin");
